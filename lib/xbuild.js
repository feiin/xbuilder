...
function xbuilder(options) {
    ...
    const promise = new Promise((resolve, reject) => {
        ...
        var error = null;
        var buildTool = xbuildOptions.buildTool;
        if (!buildTool) {
            buildTool = 'msbuild';
        }
        //  console.log(commandOptions);
        const xbuild = spawn(buildTool, commandOptions);
...
xbuilder.getXbuildCommand = getXbuildCommand;//make getXbuildCommand public
